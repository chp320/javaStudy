...
// Thread 클래스를 상속해 클래스를 생성한 후 쓰레드 3개 생성 -> main, SMIFileThread, VideoFileThread
...
class VideoFileThread2 extends Thread {
    @Override
    public void run() {
        // 비디오 프레임 번호 1~5
...
public class CreateAndStartThread_M1C2 {
    public static void main(String[] args) {
        ...
        Thread videoFileThread = new VideoFileThread2();
